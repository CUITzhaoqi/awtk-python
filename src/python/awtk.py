...
class TCanvas(object):
    ...
    def draw_image(self, img, src, dst):
        return canvas_draw_image(awtk_get_native_obj(self), awtk_get_native_obj(img), awtk_get_native_obj(src),
                                 awtk_get_native_obj(dst));
    ...
    def draw_image_ex(self, img, draw_type, dst):
        return canvas_draw_image_ex(awtk_get_native_obj(self), awtk_get_native_obj(img), draw_type,
                                    awtk_get_native_obj(dst));
